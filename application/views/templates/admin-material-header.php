		 ...
		 <div class=" center">
		  <div class="nav-wrapper">
			...
			<ul id="nav-mobile" class="right hide-on-med-and-down">
			 <li>				
				<a href=""><span class="email primary-text-color"><?php echo $user->user_email;?></a>	
			</li>
	...
	<ul id="slide-out" class="side-nav fixed dark-primary-color text-primary-color flow-text">
		<li class="logo">
			<div class="userView ">
			  ...
			  <a href="#!email"><span class="email"><?php echo $user->user_email;?></span></a>
			</div>
		</li>
		...
		<li class="l  <?php if($title=="Calendar"){echo "default-primary-color    active ";}?>">
					<a href="<?=base_url();?>Admin/show_bidding"><i class="material-icons active">today</i>Logs</a></li>
