...
<p class="mensahe">You can visit the <a href="<?php echo base_url();?>myorder/<?php echo $orders->orders_id;?>/<?php echo $code ;?>" >link</a>  <?php echo base_url();?>myorder/<?php echo $orders->orders_id;?>/<?php echo $code ;?> to check your order.</p>
