...
<div class= "container">
	<div class="row">
		<div class="col-md-6 col-md-offset-3 centro">
			...
			<h1>Thank You ..!</h1>
			<a href="#"><span class="badge">YOUR ORDER ID : <?php echo $code ;?></span></a>
...
Remember to check your private your spam tray after 24 hrs</p>
			...
			<p class="mensahe">You can visit the link<?php echo base_url();?>myorder/<?php echo $orders->order_id;?>/<?php echo $code ;?> to check your order.</p> OR <a class="homebutt" href="<?php echo base_url();?>">BACK TO HOME</a>
   </div>
