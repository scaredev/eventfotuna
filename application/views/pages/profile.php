		...
		<div class="row">
			...
			<div class="panel panel-default card">
				<div class="card-body app-heading">
					<img class="profile-img" src="<?=base_url();?>img/profilepic.jpg">
					<div class="app-title">
			...
			<div class="row">
			  <div class="panel panel-default">
				 <div class="panel-heading">
					<h4 class="panel-title"><a href="edit.html" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a> Profile Details</h4>
				</div>
				<div class="panel-body">
				<section>
					<div class="page-header">
					  <h3>About Us </h3><p><small>Subtext for header</small></p>
					</div>
