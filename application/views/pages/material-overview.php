<main>
	<div class="ul-wrapper flow-text">
			  ...
			  <ul class="collapsible collapsible-override" data-collapsible="accordion">
				...
				<div class="collapsible-header ">
						...
						<i class="material-icons secondary-text-color">person_pin</i><?php echo $orders->orders_id;?>: <?php echo $orders->name;?>
						<div class="right hide-on-small-and-down">
							
						<span class="left databits"><i class="material-icons secondary-text-color">supervisor_account</i><?php echo $orders->participants;?> participants</span>
						<span class="left databits"><i class="material-icons secondary-text-color">location_on</i>zip code: <?php echo $orders->zipcode;?></span>
				  ...
				  <div class="collapsible-body">
				    <p class="left">More Details:<br/>
						    <span class=" databits"><i class="material-icons secondary-text-color">supervisor_account</i><?php echo $orders->partytype;?></span>
							<span class=" databits"><i class="material-icons secondary-text-color">supervisor_account</i><?php echo $orders->participants;?> participants</span>
							<span class=" databits"><i class="material-icons secondary-text-color">language</i>Party host: <?php echo $orders->party;?></span>
							<span class=" databits"><i class="material-icons secondary-text-color">location_on</i>zip code: <?php echo $orders->zipcode;?></span>
					</p>
					<div class="right hide-on-med-and-up">
					  ...
					  <div class="row">
						...
						<div class="input-field col s6 m4 l4">
							<button class="chip btn btn-flat waves-effect waves-light" type="submit" name="action">Submit
