										...
										<div class="panel-body">
												<div class="page-header">
												  ...
												  <div class="input-group">
													 <button class="btn btn-primary btn-lg">Upgrade now!</button> <h3>Upgrage to pro user</h3>
												  </div>
												</div>
											...
											<div class="row">
													...
													<div class="panel panel-default">
														...
														<div class="panel-body">											 
																<div class="form-group">
																  <label class="radio-inline  control-label">Notify me by email</label>
												...
												<div class="col-md-4">
													<div class="panel panel-default">
														<div class="panel-heading">Address Settings</div>
														<div class="panel-body">											 
															<div class="form-group">
